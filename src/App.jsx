    ...
    <div className="page">
      ...
      <main>
        ...
        <section id="intro" className="section wrap">
          <SectionHead title="Introduction" kicker="First steps" />
          <div className="grid-2">
            <article className="card card--tilt">
              ...
              <p>
                I’m pursuing a <strong>Master’s degree</strong> and focusing on
                areas related to{" "}
                <strong>computer science and network security</strong>. This term
                I’m taking a hands-on{" "}
                <strong>Network Attack and Defense</strong> course to connect theory
            ...
            <article className="card">
              ...
              <p>
                Outside class, I like reading about how systems fail in the wild,
                tinkering with small coding projects, and staying active outdoors. I
                also enjoy meeting classmates to swap debugging stories and study
                tips.
              </p>
        ...
        <section id="interests" className="section wrap section-alt">
          <SectionHead title="Skills to grow" kicker="Study notes" />
          <div className="grid-3">
            <article className="card card-compact card--numbered" data-index="01">
              <h3>Traffic analysis</h3>
              <p>
                Build intuition for normal vs. suspicious patterns using captures
                and structured notes.
              </p>
            </article>
            <article className="card card-compact card--numbered" data-index="02">
              <h3>Secure design</h3>
              <p>
                Practice threat modeling and defensive controls instead of only
                chasing exploits.
              </p>
            </article>
            <article className="card card-compact card--numbered" data-index="03">
              <h3>Automation</h3>
              <p>
                Use small, reliable scripts to repeat checks and reduce manual
                mistakes during labs.
              </p>
            </article>
          </div>
        </section>
